    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.teacherName}>{user?.email?.split('@')[0] || '講師'}さん</Text>
        </View>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={[
              styles.tabLabel,
              activeTab === 'students' && styles.tabLabelActive,
            ]}
          >
            生徒
          </Text>
      ...
      {activeTab === 'students' && (
        <ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
          <Text style={styles.sectionTitle} style={[styles.sectionTitle, { marginBottom: 12 }]}>
            担当生徒一覧
          </Text>
      ...
      {/* Analytics Tab */}
      {activeTab === 'analytics' && (
        <TeacherAnalytics classStats={classStats} students={students} weeklyProgress={weeklyProgress} />
      )}
